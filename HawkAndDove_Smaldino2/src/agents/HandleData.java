...
import agents.control.SimController;
...
public class HandleData implements java.io.Serializable {
	...
	//	System.out.println(thedata);
		System.out.println("Hawk pay vrs Hawk : " + AgentsSimulation.hawk_pay_vs_hawk + "\t Injury_Cost: " + AgentsSimulation.Injury_Cost + "\t Dove pay vrs Hawk : " + AgentsSimulation.dove_pay_vs_hawk + "\t Dove pay vrs dove : " + AgentsSimulation.dove_pay_vs_dove + "\t Energy Loss : " + AgentsSimulation.Energy_Loss);
	}
